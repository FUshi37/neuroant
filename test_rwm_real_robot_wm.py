                ...
                safety_writer.writerow(
                    {
                        ...
                        "lift_hip_forward_target": float(candidate_debug.get("lift_hip_forward_target", 0.0)),
                        "lift_hip_forward_blend": float(candidate_debug.get("lift_hip_forward_blend", 0.0)),
                        "lift_knee_final_target": float(candidate_debug.get("lift_knee_final_target", 0.0)),
                        "lift_knee_raw_target": float(candidate_debug.get("lift_knee_raw_target", 0.0)),
                        "lift_knee_blend": float(candidate_debug.get("lift_knee_blend", 0.0)),
                        "lift_ankle_final_target": float(candidate_debug.get("lift_ankle_final_target", 0.0)),
                        "lift_ankle_raw_target": float(candidate_debug.get("lift_ankle_raw_target", 0.0)),
                        "lift_ankle_blend": float(candidate_debug.get("lift_ankle_blend", 0.0)),
